...
PGPASSWORD=3QIfWVSayB psql -h orangeskylab-1.c9ejcf8ctlf9.us-west-2.rds.amazonaws.com -p 5432 -U postgres -d postgres -w -c "DROP TABLE CASCADE IF EXISTS markprice, settlementprice, orderstable;"
