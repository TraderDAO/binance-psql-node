...
psql -d traderDao -c  "create table alpha(id serial primary key, symbol text, receiveTime text, alarm numeric, pix numeric, stopOut numeric, inOut numeric, noDays numeric); "
